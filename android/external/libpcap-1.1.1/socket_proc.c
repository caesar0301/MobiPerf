...
void StartCapture(char * pcapFilename) {	
	...
	{
	//sync time
		sprintf(pcapFilename, "%s/time", gszFileDir);
		...
		//event file
		sprintf(pcapFilename, "%s/processed_events", gszFileDir);
		...
		//appid file
		sprintf(pcapFilename, "%s/appid", gszFileDir);
		...
		//appname file
		sprintf(pcapFilename, "%s/appname", gszFileDir);
		...
		//cpu file
		/*
		sprintf(pcapFilename, "%s/cpu", gszFileDir);
	...
	sprintf(pcapFilename, "%s/traffic.cap", gszFileDir);
	printf("Pcap file: %s\n", pcapFilename);	
	...
	{
		sprintf(pcapFilename, "%s/traffic%d.cap", gszFileDir,bearerChangedvalue);
