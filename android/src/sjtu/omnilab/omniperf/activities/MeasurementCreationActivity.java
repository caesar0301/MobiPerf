...
import sjtu.omnilab.omniperf.measurements.DnsLookupTask;
import sjtu.omnilab.omniperf.measurements.DnsLookupTask.DnsLookupDesc;
import sjtu.omnilab.omniperf.measurements.HttpTask;
import sjtu.omnilab.omniperf.measurements.HttpTask.HttpDesc;
import sjtu.omnilab.omniperf.measurements.PingTask;
import sjtu.omnilab.omniperf.measurements.PingTask.PingDesc;
import sjtu.omnilab.omniperf.measurements.TCPThroughputTask;
import sjtu.omnilab.omniperf.measurements.TCPThroughputTask.TCPThroughputDesc;
import sjtu.omnilab.omniperf.measurements.TracerouteTask;
import sjtu.omnilab.omniperf.measurements.TracerouteTask.TracerouteDesc;
import sjtu.omnilab.omniperf.measurements.UDPBurstTask;
import sjtu.omnilab.omniperf.measurements.UDPBurstTask.UDPBurstDesc;
    ...
    public void onClick(View v) {
      ...
      try {
        if (measurementTypeUnderEdit.equals(PingTask.TYPE)) {
          ...
          // m-lab.
          params.put("target", MeasurementCreationActivity.this.getString(R.string.TCPTaskServerAddress));
          ...
          newTask =
            ...
            Map<String, String> params = new HashMap<String, String>();
            params.put("target", MeasurementCreationActivity.this.getString(R.string.UDPTaskServerAddress));
        ...
        if (newTask != null) {
          MeasurementSchedulerService scheduler = parent.getScheduler();
          ...
          if (scheduler != null && scheduler.submitTask(newTask)) {
            ...
            OmniperfMainActivity parent = (OmniperfMainActivity) getParent();
