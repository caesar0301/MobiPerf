...
package sjtu.omnilab.omniperf.measurements;
...
import sjtu.omnilab.omniperf.core.MeasurementDesc;
import sjtu.omnilab.omniperf.core.MeasurementError;
import sjtu.omnilab.omniperf.core.MeasurementJsonConvertor;
import sjtu.omnilab.omniperf.core.MeasurementResult;
...
public class PingTask extends MeasurementTask {
  ...
  private double filterPingResults(final ArrayList<Double> rrts, double avg) {
    ...
    try {
      ...
      Log.wtf(OmniperfMainActivity.TAG, "This should never happen because rrts is never empty");
    }
    return rrtAvg;
  }
