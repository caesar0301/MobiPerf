...
public class BatteryCapPowerManager {
  ...
  public static class PowerAwareTask implements Callable<MeasurementResult> {
    ...
    public PowerAwareTask(MeasurementTask task, OmniperfApp app) {
      realTask = task;
      this.mApp = app;
      this.pManager = app.getPowerManager();
      this.scheduler = new MeasurementSchedulerService();
    ...
    public MeasurementResult call() throws MeasurementError {
      ...
      try {
        ...
        if ( this.mPreferences.getBoolean(Config.PREF_KEY_IS_PAUSE_REQUESTED, false) ) {
